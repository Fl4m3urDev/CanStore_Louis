      ...
      <form method="post" class="d-flex flex-row w-100">
        <div class="d-flex flex-column me-2">
          ...
          <select class="py-3 text-warning bg-success" id="category" name="category">
            <option <?php if ($type == 'Tous') echo 'selected'; ?>>Tous</option>
            <option <?php if ($type == 'legumes') echo 'selected'; ?>>legumes</option>
            <option <?php if ($type == 'viande') echo 'selected'; ?>>viande</option>
            <option <?php if ($type == 'soupe') echo 'selected'; ?>>soupe</option>
          </select>
        </div>
        <div class="d-flex flex-column me-2">
          ...
          <select class="py-3 text-warning bg-success" id="nutriscore" name="nutriscore">
            ...
            <option <?php if ($nutriscore == 'A') echo 'selected'; ?>>A</option>
            <option <?php if ($nutriscore == 'B') echo 'selected'; ?>>B</option>
            <option <?php if ($nutriscore == 'C') echo 'selected'; ?>>C</option>
            <option <?php if ($nutriscore == 'D') echo 'selected'; ?>>D</option>
            <option <?php if ($nutriscore == 'E') echo 'selected'; ?>>E</option>
          </select>
        </div>
        <div class="d-flex flex-column me-2">
          <label class="mb-1" for="searchTerm">Entrez le terme de recherche :</label>
          <input class="py-3 text-warning bg-success" type="text" name="searchTerm" id="searchTerm" list="listeValeurs" placeholder="Exemple : haricots" value='<?php echo $search;?>'>
